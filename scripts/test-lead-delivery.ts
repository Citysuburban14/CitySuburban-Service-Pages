...
async function run() {
  ...
  process.env.LEAD_FROM_EMAIL = 'City & Suburban Heating & Cooling <leads@updates.example.com>'
  ...
  assert.equal(email.from, 'City & Suburban Heating & Cooling <leads@updates.example.com>')

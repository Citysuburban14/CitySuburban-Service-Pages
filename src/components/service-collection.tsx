      ...
      <div className="collection-wrap">
        <div className="collection-directory-heading">
          <div>
            ...
            <h2 id="service-directory-title">Find the right HVAC service</h2>
          </div>
          <p>Browse locally focused service pages for heating, cooling, air quality, and commercial HVAC needs across Chicago and nearby suburbs.</p>
        </div>
